...
Plan source-refresh execution waves without certifying current facts.
...
| --- | --- | --- | --- | --- | --- | --- |
| `TICKET-SRC-004` | [finance-agent-wiki](../wikis/finance-agent-wiki) | P0 | wave-1 | high | yes | current fees, funding rates, margin rules, tax rules and trading API parameters |
...
- Title: P0 priority batch
- Tickets: 15
- Human confirmation gates: 4
- Description: Use this view when the next source-refresh session is organized by wiki priority.
...
- Title: P1 priority batch
- Tickets: 12
- Human confirmation gates: 6
- Description: Use this view when the next source-refresh session is organized by wiki priority.
...
- Title: Human confirmation batch
- Tickets: 16
- Human confirmation gates: 16
- Description: These tickets need explicit human review before any verified/current-fact use.
...
No filters supplied; selected queue equals the full recommended open-ticket queue.
...
- Source log: [source-refresh-log.md](../wikis/finance-agent-wiki/sources/source-refresh-log.md)
...
```bash
python3 scripts/record_source_evidence.py --ticket-id TICKET-SRC-005 --status still-needs-source-update --source-title "<source title>" --source-publisher "<publisher>" --source-url-or-reference "<url or local reference>" --source-published-or-updated "YYYY-MM-DD | unknown" --evidence-summary "<what the source supports and does not support>" --confidence low --remaining-uncertainty "<remaining uncertainty>" --human-reviewer "<reviewer>"
```
...
```bash
python3 scripts/record_source_evidence.py --ticket-id TICKET-SRC-006 --status still-needs-source-update --source-title "<source title>" --source-publisher "<publisher>" --source-url-or-reference "<url or local reference>" --source-published-or-updated "YYYY-MM-DD | unknown" --evidence-summary "<what the source supports and does not support>" --confidence low --remaining-uncertainty "<remaining uncertainty>" --human-reviewer "<reviewer>"
```
...
- Source log: [source-refresh-log.md](../wikis/airdrop-agent-wiki/sources/source-refresh-log.md)
...
```bash
python3 scripts/record_source_evidence.py --ticket-id TICKET-SRC-002 --status still-needs-source-update --source-title "<source title>" --source-publisher "<publisher>" --source-url-or-reference "<url or local reference>" --source-published-or-updated "YYYY-MM-DD | unknown" --evidence-summary "<what the source supports and does not support>" --confidence low --remaining-uncertainty "<remaining uncertainty>" --human-reviewer "<reviewer>"
```
...
- Source log: [source-refresh-log.md](../wikis/health-agent-wiki/sources/source-refresh-log.md)
...
```bash
python3 scripts/record_source_evidence.py --ticket-id TICKET-SRC-008 --status still-needs-source-update --source-title "<source title>" --source-publisher "<publisher>" --source-url-or-reference "<url or local reference>" --source-published-or-updated "YYYY-MM-DD | unknown" --evidence-summary "<what the source supports and does not support>" --confidence low --remaining-uncertainty "<remaining uncertainty>" --human-reviewer "<reviewer>"
```
