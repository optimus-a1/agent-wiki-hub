...
| Path | Result |
| --- | --- |
| dashboard/README.md | PASS |
| dashboard/package.json | PASS |
| dashboard/index.html | PASS |
| dashboard/src/main.js | PASS |
| dashboard/src/styles.css | PASS |
| dashboard/data/dashboard-summary.json | PASS |
| dashboard/data/wiki-status.json | PASS |
