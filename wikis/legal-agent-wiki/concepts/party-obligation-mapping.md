---
title: "Party Obligation Mapping"
...
## Purpose
This page gives agents a stable concept pattern for party obligation mapping in `legal-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Party Obligation Mapping should be handled as concept knowledge that supports repeatable agent behavior.
...
## Examples
- Use party obligation mapping to convert a vague request into explicit fields, checks, and boundaries.
- Use party obligation mapping as a checklist item before the agent produces a final answer.
- Use party obligation mapping during review to separate supported observations from unresolved risks.
- Use party obligation mapping to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating party obligation mapping as permission to invent missing details.
