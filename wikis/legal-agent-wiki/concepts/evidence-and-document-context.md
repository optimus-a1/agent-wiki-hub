---
title: "Evidence And Document Context"
...
## Purpose
This page gives agents a stable concept pattern for evidence and document context in `legal-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Evidence And Document Context should be handled as concept knowledge that supports repeatable agent behavior.
...
## Examples
- Use evidence and document context to convert a vague request into explicit fields, checks, and boundaries.
- Use evidence and document context as a checklist item before the agent produces a final answer.
- Use evidence and document context during review to separate supported observations from unresolved risks.
- Use evidence and document context to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating evidence and document context as permission to invent missing details.
