---
title: "Legal Information Vs Advice"
...
## Purpose
This page gives agents a stable concept pattern for legal information vs advice in `legal-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Legal Information Vs Advice should be handled as concept knowledge that supports repeatable agent behavior.
...
## Examples
- Use legal information vs advice to convert a vague request into explicit fields, checks, and boundaries.
- Use legal information vs advice as a checklist item before the agent produces a final answer.
- Use legal information vs advice during review to separate supported observations from unresolved risks.
- Use legal information vs advice to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating legal information vs advice as permission to invent missing details.
