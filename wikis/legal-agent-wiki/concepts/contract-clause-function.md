---
title: "Contract Clause Function"
...
# Contract Clause Function

## Purpose
This page gives agents a stable concept pattern for contract clause function in `legal-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Contract Clause Function should be handled as concept knowledge that supports repeatable agent behavior.
...
## Examples
- Use contract clause function to convert a vague request into explicit fields, checks, and boundaries.
- Use contract clause function as a checklist item before the agent produces a final answer.
- Use contract clause function during review to separate supported observations from unresolved risks.
- Use contract clause function to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating contract clause function as permission to invent missing details.
