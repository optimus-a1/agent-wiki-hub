---
title: "Case Legal Conclusion Refusal"
...
# Case Legal Conclusion Refusal

## Purpose
This page gives agents a stable case pattern for case legal conclusion refusal in `legal-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Case Legal Conclusion Refusal should be handled as case knowledge that supports repeatable agent behavior.
...
## Examples
- Use case legal conclusion refusal to convert a vague request into explicit fields, checks, and boundaries.
- Use case legal conclusion refusal as a checklist item before the agent produces a final answer.
- Use case legal conclusion refusal during review to separate supported observations from unresolved risks.
- Use case legal conclusion refusal to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating case legal conclusion refusal as permission to invent missing details.
