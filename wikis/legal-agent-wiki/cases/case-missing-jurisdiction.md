---
title: "Case Missing Jurisdiction"
...
## Purpose
This page gives agents a stable case pattern for case missing jurisdiction in `legal-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Case Missing Jurisdiction should be handled as case knowledge that supports repeatable agent behavior.
...
## Examples
- Use case missing jurisdiction to convert a vague request into explicit fields, checks, and boundaries.
- Use case missing jurisdiction as a checklist item before the agent produces a final answer.
- Use case missing jurisdiction during review to separate supported observations from unresolved risks.
- Use case missing jurisdiction to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating case missing jurisdiction as permission to invent missing details.
