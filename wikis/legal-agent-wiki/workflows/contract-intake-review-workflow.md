---
title: "Contract Intake Review Workflow"
...
# Contract Intake Review Workflow

## Purpose
This page gives agents a stable workflow pattern for contract intake review workflow in `legal-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Contract Intake Review Workflow should be handled as workflow knowledge that supports repeatable agent behavior.
...
## Examples
- Use contract intake review workflow to convert a vague request into explicit fields, checks, and boundaries.
- Use contract intake review workflow as a checklist item before the agent produces a final answer.
- Use contract intake review workflow during review to separate supported observations from unresolved risks.
- Use contract intake review workflow to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating contract intake review workflow as permission to invent missing details.
