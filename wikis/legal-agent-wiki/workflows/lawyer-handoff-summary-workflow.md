---
title: "Lawyer Handoff Summary Workflow"
...
# Lawyer Handoff Summary Workflow

## Purpose
This page gives agents a stable workflow pattern for lawyer handoff summary workflow in `legal-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Lawyer Handoff Summary Workflow should be handled as workflow knowledge that supports repeatable agent behavior.
...
## Examples
- Use lawyer handoff summary workflow to convert a vague request into explicit fields, checks, and boundaries.
- Use lawyer handoff summary workflow as a checklist item before the agent produces a final answer.
- Use lawyer handoff summary workflow during review to separate supported observations from unresolved risks.
- Use lawyer handoff summary workflow to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating lawyer handoff summary workflow as permission to invent missing details.
