---
title: "Legal Information Triage Prompt"
...
# Legal Information Triage Prompt

## Purpose
This page gives agents a stable prompt pattern for legal information triage prompt in `legal-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Legal Information Triage Prompt should be handled as prompt knowledge that supports repeatable agent behavior.
...
## Examples
- Use legal information triage prompt to convert a vague request into explicit fields, checks, and boundaries.
- Use legal information triage prompt as a checklist item before the agent produces a final answer.
- Use legal information triage prompt during review to separate supported observations from unresolved risks.
- Use legal information triage prompt to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating legal information triage prompt as permission to invent missing details.
