---
title: "Case Patch Without Review"
...
# Case Patch Without Review

## Purpose
This page gives agents a stable case pattern for case patch without review in `security-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Case Patch Without Review should be handled as case knowledge that supports repeatable agent behavior.
...
## Examples
- Use case patch without review to convert a vague request into explicit fields, checks, and boundaries.
- Use case patch without review as a checklist item before the agent produces a final answer.
- Use case patch without review during review to separate supported observations from unresolved risks.
- Use case patch without review to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating case patch without review as permission to invent missing details.
