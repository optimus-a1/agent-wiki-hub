---
title: "Benchmark Claim Review Workflow"
...
# Benchmark Claim Review Workflow

## Purpose
This page gives agents a stable workflow pattern for benchmark claim review workflow in `research-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Benchmark Claim Review Workflow should be handled as workflow knowledge that supports repeatable agent behavior.
...
## Examples
- Use benchmark claim review workflow to convert a vague request into explicit fields, checks, and boundaries.
- Use benchmark claim review workflow as a checklist item before the agent produces a final answer.
- Use benchmark claim review workflow during review to separate supported observations from unresolved risks.
- Use benchmark claim review workflow to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating benchmark claim review workflow as permission to invent missing details.
