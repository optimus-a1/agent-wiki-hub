---
title: "Case Fabricated Citation"
...
## Purpose
This page gives agents a stable case pattern for case fabricated citation in `research-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Case Fabricated Citation should be handled as case knowledge that supports repeatable agent behavior.
...
## Examples
- Use case fabricated citation to convert a vague request into explicit fields, checks, and boundaries.
- Use case fabricated citation as a checklist item before the agent produces a final answer.
- Use case fabricated citation during review to separate supported observations from unresolved risks.
- Use case fabricated citation to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating case fabricated citation as permission to invent missing details.
