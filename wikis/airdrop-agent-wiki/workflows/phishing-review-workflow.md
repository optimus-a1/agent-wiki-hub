---
title: "Phishing Review Workflow"
...
# Phishing Review Workflow

## Purpose
This page gives agents a stable workflow pattern for phishing review workflow in `airdrop-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Phishing Review Workflow should be handled as workflow knowledge that supports repeatable agent behavior.
...
## Examples
- Use phishing review workflow to convert a vague request into explicit fields, checks, and boundaries.
- Use phishing review workflow as a checklist item before the agent produces a final answer.
- Use phishing review workflow during review to separate supported observations from unresolved risks.
- Use phishing review workflow to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating phishing review workflow as permission to invent missing details.
