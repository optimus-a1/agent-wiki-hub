---
title: "Project Research Workflow"
...
## Purpose
This page gives agents a stable workflow pattern for project research workflow in `airdrop-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Project Research Workflow should be handled as workflow knowledge that supports repeatable agent behavior.
...
## Examples
- Use project research workflow to convert a vague request into explicit fields, checks, and boundaries.
- Use project research workflow as a checklist item before the agent produces a final answer.
- Use project research workflow during review to separate supported observations from unresolved risks.
- Use project research workflow to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating project research workflow as permission to invent missing details.
