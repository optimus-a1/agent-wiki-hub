---
title: "Source Review For Airdrop Claims"
...
# Source Review For Airdrop Claims

## Purpose
This page gives agents a stable workflow pattern for source review for airdrop claims in `airdrop-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Source Review For Airdrop Claims should be handled as workflow knowledge that supports repeatable agent behavior.
...
## Examples
- Use source review for airdrop claims to convert a vague request into explicit fields, checks, and boundaries.
- Use source review for airdrop claims as a checklist item before the agent produces a final answer.
- Use source review for airdrop claims during review to separate supported observations from unresolved risks.
- Use source review for airdrop claims to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating source review for airdrop claims as permission to invent missing details.
