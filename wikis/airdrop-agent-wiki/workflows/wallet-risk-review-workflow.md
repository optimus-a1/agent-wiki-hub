---
title: "Wallet Risk Review Workflow"
...
# Wallet Risk Review Workflow

## Purpose
This page gives agents a stable workflow pattern for wallet risk review workflow in `airdrop-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Wallet Risk Review Workflow should be handled as workflow knowledge that supports repeatable agent behavior.
...
## Examples
- Use wallet risk review workflow to convert a vague request into explicit fields, checks, and boundaries.
- Use wallet risk review workflow as a checklist item before the agent produces a final answer.
- Use wallet risk review workflow during review to separate supported observations from unresolved risks.
- Use wallet risk review workflow to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating wallet risk review workflow as permission to invent missing details.
