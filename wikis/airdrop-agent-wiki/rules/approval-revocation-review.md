---
title: "Approval Revocation Review"
...
# Approval Revocation Review

## Purpose
This page gives agents a stable rule pattern for approval revocation review in `airdrop-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Approval Revocation Review should be handled as rule knowledge that supports repeatable agent behavior.
...
## Examples
- Use approval revocation review to convert a vague request into explicit fields, checks, and boundaries.
- Use approval revocation review as a checklist item before the agent produces a final answer.
- Use approval revocation review during review to separate supported observations from unresolved risks.
- Use approval revocation review to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating approval revocation review as permission to invent missing details.
