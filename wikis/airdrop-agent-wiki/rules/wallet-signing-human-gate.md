---
title: "Wallet Signing Human Gate"
...
# Wallet Signing Human Gate

## Purpose
This page gives agents a stable rule pattern for wallet signing human gate in `airdrop-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Wallet Signing Human Gate should be handled as rule knowledge that supports repeatable agent behavior.
...
## Examples
- Use wallet signing human gate to convert a vague request into explicit fields, checks, and boundaries.
- Use wallet signing human gate as a checklist item before the agent produces a final answer.
- Use wallet signing human gate during review to separate supported observations from unresolved risks.
- Use wallet signing human gate to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating wallet signing human gate as permission to invent missing details.
