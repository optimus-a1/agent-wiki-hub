---
title: "No Unverified Project Claims"
...
# No Unverified Project Claims

## Purpose
This page gives agents a stable rule pattern for no unverified project claims in `airdrop-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- No Unverified Project Claims should be handled as rule knowledge that supports repeatable agent behavior.
...
## Examples
- Use no unverified project claims to convert a vague request into explicit fields, checks, and boundaries.
- Use no unverified project claims as a checklist item before the agent produces a final answer.
- Use no unverified project claims during review to separate supported observations from unresolved risks.
- Use no unverified project claims to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating no unverified project claims as permission to invent missing details.
