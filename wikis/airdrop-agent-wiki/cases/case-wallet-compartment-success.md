---
title: "Case Wallet Compartment Success"
...
# Case Wallet Compartment Success

## Purpose
This page gives agents a stable case pattern for case wallet compartment success in `airdrop-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Case Wallet Compartment Success should be handled as case knowledge that supports repeatable agent behavior.
...
## Examples
- Use case wallet compartment success to convert a vague request into explicit fields, checks, and boundaries.
- Use case wallet compartment success as a checklist item before the agent produces a final answer.
- Use case wallet compartment success during review to separate supported observations from unresolved risks.
- Use case wallet compartment success to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating case wallet compartment success as permission to invent missing details.
