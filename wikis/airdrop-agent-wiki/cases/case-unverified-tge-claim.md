---
title: "Case Unverified Tge Claim"
...
# Case Unverified Tge Claim

## Purpose
This page gives agents a stable case pattern for case unverified tge claim in `airdrop-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Case Unverified Tge Claim should be handled as case knowledge that supports repeatable agent behavior.
...
## Examples
- Use case unverified tge claim to convert a vague request into explicit fields, checks, and boundaries.
- Use case unverified tge claim as a checklist item before the agent produces a final answer.
- Use case unverified tge claim during review to separate supported observations from unresolved risks.
- Use case unverified tge claim to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating case unverified tge claim as permission to invent missing details.
