---
title: "Case Sybil Evasion Request"
...
# Case Sybil Evasion Request

## Purpose
This page gives agents a stable case pattern for case sybil evasion request in `airdrop-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Case Sybil Evasion Request should be handled as case knowledge that supports repeatable agent behavior.
...
## Examples
- Use case sybil evasion request to convert a vague request into explicit fields, checks, and boundaries.
- Use case sybil evasion request as a checklist item before the agent produces a final answer.
- Use case sybil evasion request during review to separate supported observations from unresolved risks.
- Use case sybil evasion request to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating case sybil evasion request as permission to invent missing details.
