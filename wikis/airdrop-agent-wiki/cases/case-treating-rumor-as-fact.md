---
title: "Case Treating Rumor As Fact"
...
# Case Treating Rumor As Fact

## Purpose
This page gives agents a stable case pattern for case treating rumor as fact in `airdrop-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Case Treating Rumor As Fact should be handled as case knowledge that supports repeatable agent behavior.
...
## Examples
- Use case treating rumor as fact to convert a vague request into explicit fields, checks, and boundaries.
- Use case treating rumor as fact as a checklist item before the agent produces a final answer.
- Use case treating rumor as fact during review to separate supported observations from unresolved risks.
- Use case treating rumor as fact to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating case treating rumor as fact as permission to invent missing details.
