...
# Funding Claim Boundary

## Purpose
This page gives agents a stable concept pattern for funding claim boundary in `airdrop-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Funding Claim Boundary should be handled as concept knowledge that supports repeatable agent behavior.
...
## Examples
- Use funding claim boundary to convert a vague request into explicit fields, checks, and boundaries.
- Use funding claim boundary as a checklist item before the agent produces a final answer.
- Use funding claim boundary during review to separate supported observations from unresolved risks.
- Use funding claim boundary to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating funding claim boundary as permission to invent missing details.
