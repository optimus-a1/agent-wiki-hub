---
title: "Project Research Checklist"
...
## Purpose
This page gives agents a stable concept pattern for project research checklist in `airdrop-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Project Research Checklist should be handled as concept knowledge that supports repeatable agent behavior.
...
## Examples
- Use project research checklist to convert a vague request into explicit fields, checks, and boundaries.
- Use project research checklist as a checklist item before the agent produces a final answer.
- Use project research checklist during review to separate supported observations from unresolved risks.
- Use project research checklist to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating project research checklist as permission to invent missing details.
