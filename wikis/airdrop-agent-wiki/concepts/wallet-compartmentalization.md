---
title: "Wallet Compartmentalization"
...
## Purpose
This page gives agents a stable concept pattern for wallet compartmentalization in `airdrop-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Wallet Compartmentalization should be handled as concept knowledge that supports repeatable agent behavior.
...
## Examples
- Use wallet compartmentalization to convert a vague request into explicit fields, checks, and boundaries.
- Use wallet compartmentalization as a checklist item before the agent produces a final answer.
- Use wallet compartmentalization during review to separate supported observations from unresolved risks.
- Use wallet compartmentalization to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating wallet compartmentalization as permission to invent missing details.
