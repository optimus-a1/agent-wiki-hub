---
title: "Market Data Quality Review"
...
# Market Data Quality Review

## Purpose
This page gives agents a stable workflow pattern for market data quality review in `finance-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Market Data Quality Review should be handled as workflow knowledge that supports repeatable agent behavior.
...
## Examples
- Use market data quality review to convert a vague request into explicit fields, checks, and boundaries.
- Use market data quality review as a checklist item before the agent produces a final answer.
- Use market data quality review during review to separate supported observations from unresolved risks.
- Use market data quality review to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating market data quality review as permission to invent missing details.
