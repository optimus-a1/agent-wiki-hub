---
title: "Portfolio Risk Review Workflow"
...
## Purpose
This page gives agents a stable workflow pattern for portfolio risk review workflow in `finance-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Portfolio Risk Review Workflow should be handled as workflow knowledge that supports repeatable agent behavior.
...
## Examples
- Use portfolio risk review workflow to convert a vague request into explicit fields, checks, and boundaries.
- Use portfolio risk review workflow as a checklist item before the agent produces a final answer.
- Use portfolio risk review workflow during review to separate supported observations from unresolved risks.
- Use portfolio risk review workflow to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating portfolio risk review workflow as permission to invent missing details.
