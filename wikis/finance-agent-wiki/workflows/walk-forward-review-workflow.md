---
title: "Walk Forward Review Workflow"
...
# Walk Forward Review Workflow

## Purpose
This page gives agents a stable workflow pattern for walk forward review workflow in `finance-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Walk Forward Review Workflow should be handled as workflow knowledge that supports repeatable agent behavior.
...
## Examples
- Use walk forward review workflow to convert a vague request into explicit fields, checks, and boundaries.
- Use walk forward review workflow as a checklist item before the agent produces a final answer.
- Use walk forward review workflow during review to separate supported observations from unresolved risks.
- Use walk forward review workflow to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating walk forward review workflow as permission to invent missing details.
