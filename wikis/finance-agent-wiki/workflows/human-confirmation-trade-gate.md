---
title: "Human Confirmation Trade Gate"
...
# Human Confirmation Trade Gate

## Purpose
This page gives agents a stable workflow pattern for human confirmation trade gate in `finance-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Human Confirmation Trade Gate should be handled as workflow knowledge that supports repeatable agent behavior.
...
## Examples
- Use human confirmation trade gate to convert a vague request into explicit fields, checks, and boundaries.
- Use human confirmation trade gate as a checklist item before the agent produces a final answer.
- Use human confirmation trade gate during review to separate supported observations from unresolved risks.
- Use human confirmation trade gate to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating human confirmation trade gate as permission to invent missing details.
