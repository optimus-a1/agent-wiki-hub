---
title: "Financial Statement Triangulation"
...
# Financial Statement Triangulation

## Purpose
This page gives agents a stable workflow pattern for financial statement triangulation in `finance-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Financial Statement Triangulation should be handled as workflow knowledge that supports repeatable agent behavior.
...
## Examples
- Use financial statement triangulation to convert a vague request into explicit fields, checks, and boundaries.
- Use financial statement triangulation as a checklist item before the agent produces a final answer.
- Use financial statement triangulation during review to separate supported observations from unresolved risks.
- Use financial statement triangulation to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating financial statement triangulation as permission to invent missing details.
