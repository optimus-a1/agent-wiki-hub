---
title: "Drawdown Review Workflow"
...
## Purpose
This page gives agents a stable workflow pattern for drawdown review workflow in `finance-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Drawdown Review Workflow should be handled as workflow knowledge that supports repeatable agent behavior.
...
## Examples
- Use drawdown review workflow to convert a vague request into explicit fields, checks, and boundaries.
- Use drawdown review workflow as a checklist item before the agent produces a final answer.
- Use drawdown review workflow during review to separate supported observations from unresolved risks.
- Use drawdown review workflow to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating drawdown review workflow as permission to invent missing details.
