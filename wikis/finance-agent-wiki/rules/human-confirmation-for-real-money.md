---
title: "Human Confirmation For Real Money"
...
# Human Confirmation For Real Money

## Purpose
This page gives agents a stable rule pattern for human confirmation for real money in `finance-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Human Confirmation For Real Money should be handled as rule knowledge that supports repeatable agent behavior.
...
## Examples
- Use human confirmation for real money to convert a vague request into explicit fields, checks, and boundaries.
- Use human confirmation for real money as a checklist item before the agent produces a final answer.
- Use human confirmation for real money during review to separate supported observations from unresolved risks.
- Use human confirmation for real money to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating human confirmation for real money as permission to invent missing details.
