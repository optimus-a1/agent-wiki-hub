---
title: "No Personalized Buy Sell Advice"
...
## Purpose
This page gives agents a stable rule pattern for no personalized buy sell advice in `finance-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- No Personalized Buy Sell Advice should be handled as rule knowledge that supports repeatable agent behavior.
...
## Examples
- Use no personalized buy sell advice to convert a vague request into explicit fields, checks, and boundaries.
- Use no personalized buy sell advice as a checklist item before the agent produces a final answer.
- Use no personalized buy sell advice during review to separate supported observations from unresolved risks.
- Use no personalized buy sell advice to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating no personalized buy sell advice as permission to invent missing details.
