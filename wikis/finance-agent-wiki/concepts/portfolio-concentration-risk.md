...
## Purpose
This page gives agents a stable concept pattern for portfolio concentration risk in `finance-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Portfolio Concentration Risk should be handled as concept knowledge that supports repeatable agent behavior.
...
## Examples
- Use portfolio concentration risk to convert a vague request into explicit fields, checks, and boundaries.
- Use portfolio concentration risk as a checklist item before the agent produces a final answer.
- Use portfolio concentration risk during review to separate supported observations from unresolved risks.
- Use portfolio concentration risk to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating portfolio concentration risk as permission to invent missing details.
