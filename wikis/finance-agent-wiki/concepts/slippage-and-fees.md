...
## Purpose
This page gives agents a stable concept pattern for slippage and fees in `finance-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Slippage And Fees should be handled as concept knowledge that supports repeatable agent behavior.
...
## Examples
- Use slippage and fees to convert a vague request into explicit fields, checks, and boundaries.
- Use slippage and fees as a checklist item before the agent produces a final answer.
- Use slippage and fees during review to separate supported observations from unresolved risks.
- Use slippage and fees to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating slippage and fees as permission to invent missing details.
