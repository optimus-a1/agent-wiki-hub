...
## Purpose
This page gives agents a stable concept pattern for volatility and drawdown in `finance-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Volatility And Drawdown should be handled as concept knowledge that supports repeatable agent behavior.
...
## Examples
- Use volatility and drawdown to convert a vague request into explicit fields, checks, and boundaries.
- Use volatility and drawdown as a checklist item before the agent produces a final answer.
- Use volatility and drawdown during review to separate supported observations from unresolved risks.
- Use volatility and drawdown to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating volatility and drawdown as permission to invent missing details.
