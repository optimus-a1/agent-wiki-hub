...
## Purpose
This page gives agents a stable concept pattern for risk of ruin in `finance-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Risk Of Ruin should be handled as concept knowledge that supports repeatable agent behavior.
...
## Examples
- Use risk of ruin to convert a vague request into explicit fields, checks, and boundaries.
- Use risk of ruin as a checklist item before the agent produces a final answer.
- Use risk of ruin during review to separate supported observations from unresolved risks.
- Use risk of ruin to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating risk of ruin as permission to invent missing details.
