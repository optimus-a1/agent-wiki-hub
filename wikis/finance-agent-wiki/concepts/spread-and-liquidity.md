...
## Purpose
This page gives agents a stable concept pattern for spread and liquidity in `finance-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Spread And Liquidity should be handled as concept knowledge that supports repeatable agent behavior.
...
## Examples
- Use spread and liquidity to convert a vague request into explicit fields, checks, and boundaries.
- Use spread and liquidity as a checklist item before the agent produces a final answer.
- Use spread and liquidity during review to separate supported observations from unresolved risks.
- Use spread and liquidity to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating spread and liquidity as permission to invent missing details.
