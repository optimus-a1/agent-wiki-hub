---
title: "Case Paper Trading First"
...
# Case Paper Trading First

## Purpose
This page gives agents a stable case pattern for case paper trading first in `finance-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Case Paper Trading First should be handled as case knowledge that supports repeatable agent behavior.
...
## Examples
- Use case paper trading first to convert a vague request into explicit fields, checks, and boundaries.
- Use case paper trading first as a checklist item before the agent produces a final answer.
- Use case paper trading first during review to separate supported observations from unresolved risks.
- Use case paper trading first to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating case paper trading first as permission to invent missing details.
