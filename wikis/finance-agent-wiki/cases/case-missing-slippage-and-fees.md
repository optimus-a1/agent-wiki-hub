---
title: "Case Missing Slippage And Fees"
...
# Case Missing Slippage And Fees

## Purpose
This page gives agents a stable case pattern for case missing slippage and fees in `finance-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Case Missing Slippage And Fees should be handled as case knowledge that supports repeatable agent behavior.
...
## Examples
- Use case missing slippage and fees to convert a vague request into explicit fields, checks, and boundaries.
- Use case missing slippage and fees as a checklist item before the agent produces a final answer.
- Use case missing slippage and fees during review to separate supported observations from unresolved risks.
- Use case missing slippage and fees to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating case missing slippage and fees as permission to invent missing details.
