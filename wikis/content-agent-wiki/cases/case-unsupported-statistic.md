---
title: "Case Unsupported Statistic"
...
# Case Unsupported Statistic

## Purpose
This page gives agents a stable case pattern for case unsupported statistic in `content-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Case Unsupported Statistic should be handled as case knowledge that supports repeatable agent behavior.
...
## Examples
- Use case unsupported statistic to convert a vague request into explicit fields, checks, and boundaries.
- Use case unsupported statistic as a checklist item before the agent produces a final answer.
- Use case unsupported statistic during review to separate supported observations from unresolved risks.
- Use case unsupported statistic to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating case unsupported statistic as permission to invent missing details.
