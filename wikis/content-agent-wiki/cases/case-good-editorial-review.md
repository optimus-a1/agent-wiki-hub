---
title: "Case Good Editorial Review"
...
# Case Good Editorial Review

## Purpose
This page gives agents a stable case pattern for case good editorial review in `content-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Case Good Editorial Review should be handled as case knowledge that supports repeatable agent behavior.
...
## Examples
- Use case good editorial review to convert a vague request into explicit fields, checks, and boundaries.
- Use case good editorial review as a checklist item before the agent produces a final answer.
- Use case good editorial review during review to separate supported observations from unresolved risks.
- Use case good editorial review to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating case good editorial review as permission to invent missing details.
