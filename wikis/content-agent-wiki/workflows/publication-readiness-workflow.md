---
title: "Publication Readiness Workflow"
...
## Purpose
This page gives agents a stable workflow pattern for publication readiness workflow in `content-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Publication Readiness Workflow should be handled as workflow knowledge that supports repeatable agent behavior.
...
## Examples
- Use publication readiness workflow to convert a vague request into explicit fields, checks, and boundaries.
- Use publication readiness workflow as a checklist item before the agent produces a final answer.
- Use publication readiness workflow during review to separate supported observations from unresolved risks.
- Use publication readiness workflow to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating publication readiness workflow as permission to invent missing details.
