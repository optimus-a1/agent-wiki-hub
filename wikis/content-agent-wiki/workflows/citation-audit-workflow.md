...
## Purpose
This page gives agents a stable workflow pattern for citation audit workflow in `content-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.
