---
title: "Citation Discipline Prompt"
...
# Citation Discipline Prompt

## Purpose
This page gives agents a stable prompt pattern for citation discipline prompt in `content-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Citation Discipline Prompt should be handled as prompt knowledge that supports repeatable agent behavior.
...
## Examples
- Use citation discipline prompt to convert a vague request into explicit fields, checks, and boundaries.
- Use citation discipline prompt as a checklist item before the agent produces a final answer.
- Use citation discipline prompt during review to separate supported observations from unresolved risks.
- Use citation discipline prompt to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating citation discipline prompt as permission to invent missing details.
