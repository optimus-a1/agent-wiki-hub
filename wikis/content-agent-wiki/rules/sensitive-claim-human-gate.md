---
title: "Sensitive Claim Human Gate"
...
# Sensitive Claim Human Gate

## Purpose
This page gives agents a stable rule pattern for sensitive claim human gate in `content-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Sensitive Claim Human Gate should be handled as rule knowledge that supports repeatable agent behavior.
...
## Examples
- Use sensitive claim human gate to convert a vague request into explicit fields, checks, and boundaries.
- Use sensitive claim human gate as a checklist item before the agent produces a final answer.
- Use sensitive claim human gate during review to separate supported observations from unresolved risks.
- Use sensitive claim human gate to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating sensitive claim human gate as permission to invent missing details.
