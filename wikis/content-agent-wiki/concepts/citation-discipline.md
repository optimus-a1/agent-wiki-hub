...
## Purpose
This page gives agents a stable concept pattern for citation discipline in `content-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Citation Discipline should be handled as concept knowledge that supports repeatable agent behavior.
...
## Examples
- Use citation discipline to convert a vague request into explicit fields, checks, and boundaries.
- Use citation discipline as a checklist item before the agent produces a final answer.
- Use citation discipline during review to separate supported observations from unresolved risks.
- Use citation discipline to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating citation discipline as permission to invent missing details.
