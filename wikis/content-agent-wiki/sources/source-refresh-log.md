...
- [ ] SRC-033 | wave: wave-3 | priority: 5 | human_confirmation: no | topic: current image, chart, dataset and quote licensing
- [ ] SRC-034 | wave: wave-3 | priority: 5 | human_confirmation: no | topic: current news, statistics, public quotes and social media claims
- [ ] SRC-035 | wave: wave-3 | priority: 5 | human_confirmation: no | topic: current publishing platform rules, format limits and content policies
