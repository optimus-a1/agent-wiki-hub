---
title: "Case Educational Report Explanation"
...
# Case Educational Report Explanation

## Purpose
This page gives agents a stable case pattern for case educational report explanation in `health-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Case Educational Report Explanation should be handled as case knowledge that supports repeatable agent behavior.
...
## Human Gate
Require licensed clinician review for symptoms, diagnosis-like interpretation, medication, dosage, emergency risk, or care decision.

## Source Gate
Clinical guidelines, drug labels, dosage, contraindications, public health advice, and care standards require source review before use.

## Examples
- Use case educational report explanation to convert a vague request into explicit fields, checks, and boundaries.
- Use case educational report explanation as a checklist item before the agent produces a final answer.
- Use case educational report explanation during review to separate supported observations from unresolved risks.
- Use case educational report explanation to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating case educational report explanation as permission to invent missing details.
