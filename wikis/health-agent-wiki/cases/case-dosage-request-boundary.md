---
title: "Case Dosage Request Boundary"
...
# Case Dosage Request Boundary

## Purpose
This page gives agents a stable case pattern for case dosage request boundary in `health-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Case Dosage Request Boundary should be handled as case knowledge that supports repeatable agent behavior.
...
## Examples
- Use case dosage request boundary to convert a vague request into explicit fields, checks, and boundaries.
- Use case dosage request boundary as a checklist item before the agent produces a final answer.
- Use case dosage request boundary during review to separate supported observations from unresolved risks.
- Use case dosage request boundary to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating case dosage request boundary as permission to invent missing details.
