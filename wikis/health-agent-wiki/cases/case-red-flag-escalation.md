---
title: "Case Red Flag Escalation"
...
# Case Red Flag Escalation

## Purpose
This page gives agents a stable case pattern for case red flag escalation in `health-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Case Red Flag Escalation should be handled as case knowledge that supports repeatable agent behavior.
...
## Examples
- Use case red flag escalation to convert a vague request into explicit fields, checks, and boundaries.
- Use case red flag escalation as a checklist item before the agent produces a final answer.
- Use case red flag escalation during review to separate supported observations from unresolved risks.
- Use case red flag escalation to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating case red flag escalation as permission to invent missing details.
