---
title: "Clinical Guideline Source Gate"
...
# Clinical Guideline Source Gate

## Purpose
This page gives agents a stable rule pattern for clinical guideline source gate in `health-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Clinical Guideline Source Gate should be handled as rule knowledge that supports repeatable agent behavior.
...
## Examples
- Use clinical guideline source gate to convert a vague request into explicit fields, checks, and boundaries.
- Use clinical guideline source gate as a checklist item before the agent produces a final answer.
- Use clinical guideline source gate during review to separate supported observations from unresolved risks.
- Use clinical guideline source gate to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating clinical guideline source gate as permission to invent missing details.
