---
title: "Emergency Red Flag Escalation"
...
## Purpose
This page gives agents a stable rule pattern for emergency red flag escalation in `health-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Emergency Red Flag Escalation should be handled as rule knowledge that supports repeatable agent behavior.
...
## Examples
- Use emergency red flag escalation to convert a vague request into explicit fields, checks, and boundaries.
- Use emergency red flag escalation as a checklist item before the agent produces a final answer.
- Use emergency red flag escalation during review to separate supported observations from unresolved risks.
- Use emergency red flag escalation to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating emergency red flag escalation as permission to invent missing details.
