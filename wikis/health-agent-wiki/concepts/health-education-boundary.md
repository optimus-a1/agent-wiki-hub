---
title: "Health Education Boundary"
...
## Purpose
This page gives agents a stable concept pattern for health education boundary in `health-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Health Education Boundary should be handled as concept knowledge that supports repeatable agent behavior.
...
## Examples
- Use health education boundary to convert a vague request into explicit fields, checks, and boundaries.
- Use health education boundary as a checklist item before the agent produces a final answer.
- Use health education boundary during review to separate supported observations from unresolved risks.
- Use health education boundary to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating health education boundary as permission to invent missing details.
