---
title: "Lab Result Explanation Limits"
...
# Lab Result Explanation Limits

## Purpose
This page gives agents a stable concept pattern for lab result explanation limits in `health-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Lab Result Explanation Limits should be handled as concept knowledge that supports repeatable agent behavior.
...
## Examples
- Use lab result explanation limits to convert a vague request into explicit fields, checks, and boundaries.
- Use lab result explanation limits as a checklist item before the agent produces a final answer.
- Use lab result explanation limits during review to separate supported observations from unresolved risks.
- Use lab result explanation limits to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating lab result explanation limits as permission to invent missing details.
