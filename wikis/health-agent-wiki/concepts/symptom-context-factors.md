...
# Symptom Context Factors

## Purpose
This page gives agents a stable concept pattern for symptom context factors in `health-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Symptom Context Factors should be handled as concept knowledge that supports repeatable agent behavior.
...
## Examples
- Use symptom context factors to convert a vague request into explicit fields, checks, and boundaries.
- Use symptom context factors as a checklist item before the agent produces a final answer.
- Use symptom context factors during review to separate supported observations from unresolved risks.
- Use symptom context factors to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating symptom context factors as permission to invent missing details.
