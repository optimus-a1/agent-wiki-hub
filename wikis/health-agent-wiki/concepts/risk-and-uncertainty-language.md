---
title: "Risk And Uncertainty Language"
...
## Purpose
This page gives agents a stable concept pattern for risk and uncertainty language in `health-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Risk And Uncertainty Language should be handled as concept knowledge that supports repeatable agent behavior.
...
## Examples
- Use risk and uncertainty language to convert a vague request into explicit fields, checks, and boundaries.
- Use risk and uncertainty language as a checklist item before the agent produces a final answer.
- Use risk and uncertainty language during review to separate supported observations from unresolved risks.
- Use risk and uncertainty language to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating risk and uncertainty language as permission to invent missing details.
