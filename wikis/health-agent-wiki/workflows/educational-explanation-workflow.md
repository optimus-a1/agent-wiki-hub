---
title: "Educational Explanation Workflow"
...
# Educational Explanation Workflow

## Purpose
This page gives agents a stable workflow pattern for educational explanation workflow in `health-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Educational Explanation Workflow should be handled as workflow knowledge that supports repeatable agent behavior.
...
## Examples
- Use educational explanation workflow to convert a vague request into explicit fields, checks, and boundaries.
- Use educational explanation workflow as a checklist item before the agent produces a final answer.
- Use educational explanation workflow during review to separate supported observations from unresolved risks.
- Use educational explanation workflow to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating educational explanation workflow as permission to invent missing details.
