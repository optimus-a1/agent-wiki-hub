---
title: "Case Privacy Overcollection"
...
# Case Privacy Overcollection

## Purpose
This page gives agents a stable case pattern for case privacy overcollection in `ecommerce-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Case Privacy Overcollection should be handled as case knowledge that supports repeatable agent behavior.
...
## Examples
- Use case privacy overcollection to convert a vague request into explicit fields, checks, and boundaries.
- Use case privacy overcollection as a checklist item before the agent produces a final answer.
- Use case privacy overcollection during review to separate supported observations from unresolved risks.
- Use case privacy overcollection to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating case privacy overcollection as permission to invent missing details.
