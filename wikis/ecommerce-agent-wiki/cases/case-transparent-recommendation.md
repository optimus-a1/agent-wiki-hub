---
title: "Case Transparent Recommendation"
...
# Case Transparent Recommendation

## Purpose
This page gives agents a stable case pattern for case transparent recommendation in `ecommerce-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Case Transparent Recommendation should be handled as case knowledge that supports repeatable agent behavior.
...
## Examples
- Use case transparent recommendation to convert a vague request into explicit fields, checks, and boundaries.
- Use case transparent recommendation as a checklist item before the agent produces a final answer.
- Use case transparent recommendation during review to separate supported observations from unresolved risks.
- Use case transparent recommendation to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating case transparent recommendation as permission to invent missing details.
