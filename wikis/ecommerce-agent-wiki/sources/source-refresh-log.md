...
- [ ] SRC-018 | wave: wave-2 | priority: 7 | human_confirmation: no | topic: current marketplace policy, return window, category restrictions and consumer protection rules
- [ ] SRC-019 | wave: wave-2 | priority: 7 | human_confirmation: no | topic: current product certification, recall, safety notice and warranty terms
- [ ] SRC-020 | wave: wave-2 | priority: 7 | human_confirmation: no | topic: current product price, stock, promotion, shipping fee and delivery ETA
