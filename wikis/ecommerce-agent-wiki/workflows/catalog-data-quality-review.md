---
title: "Catalog Data Quality Review"
...
# Catalog Data Quality Review

## Purpose
This page gives agents a stable workflow pattern for catalog data quality review in `ecommerce-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Catalog Data Quality Review should be handled as workflow knowledge that supports repeatable agent behavior.
...
## Examples
- Use catalog data quality review to convert a vague request into explicit fields, checks, and boundaries.
- Use catalog data quality review as a checklist item before the agent produces a final answer.
- Use catalog data quality review during review to separate supported observations from unresolved risks.
- Use catalog data quality review to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating catalog data quality review as permission to invent missing details.
