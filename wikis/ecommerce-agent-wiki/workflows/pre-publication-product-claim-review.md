---
title: "Pre Publication Product Claim Review"
...
# Pre Publication Product Claim Review

## Purpose
This page gives agents a stable workflow pattern for pre publication product claim review in `ecommerce-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Pre Publication Product Claim Review should be handled as workflow knowledge that supports repeatable agent behavior.
...
## Examples
- Use pre publication product claim review to convert a vague request into explicit fields, checks, and boundaries.
- Use pre publication product claim review as a checklist item before the agent produces a final answer.
- Use pre publication product claim review during review to separate supported observations from unresolved risks.
- Use pre publication product claim review to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating pre publication product claim review as permission to invent missing details.
