---
title: "Return Refund Review Workflow"
...
# Return Refund Review Workflow

## Purpose
This page gives agents a stable workflow pattern for return refund review workflow in `ecommerce-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Return Refund Review Workflow should be handled as workflow knowledge that supports repeatable agent behavior.
...
## Examples
- Use return refund review workflow to convert a vague request into explicit fields, checks, and boundaries.
- Use return refund review workflow as a checklist item before the agent produces a final answer.
- Use return refund review workflow during review to separate supported observations from unresolved risks.
- Use return refund review workflow to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating return refund review workflow as permission to invent missing details.
