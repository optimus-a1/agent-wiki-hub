---
title: "Privacy And Consent Rule"
...
## Purpose
This page gives agents a stable rule pattern for privacy and consent rule in `ecommerce-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Privacy And Consent Rule should be handled as rule knowledge that supports repeatable agent behavior.
...
## Examples
- Use privacy and consent rule to convert a vague request into explicit fields, checks, and boundaries.
- Use privacy and consent rule as a checklist item before the agent produces a final answer.
- Use privacy and consent rule during review to separate supported observations from unresolved risks.
- Use privacy and consent rule to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating privacy and consent rule as permission to invent missing details.
