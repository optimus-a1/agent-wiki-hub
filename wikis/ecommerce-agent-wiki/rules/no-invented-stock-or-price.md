---
title: "No Invented Stock Or Price"
...
# No Invented Stock Or Price

## Purpose
This page gives agents a stable rule pattern for no invented stock or price in `ecommerce-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- No Invented Stock Or Price should be handled as rule knowledge that supports repeatable agent behavior.
...
## Examples
- Use no invented stock or price to convert a vague request into explicit fields, checks, and boundaries.
- Use no invented stock or price as a checklist item before the agent produces a final answer.
- Use no invented stock or price during review to separate supported observations from unresolved risks.
- Use no invented stock or price to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating no invented stock or price as permission to invent missing details.
