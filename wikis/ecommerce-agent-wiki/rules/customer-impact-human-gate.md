---
title: "Customer Impact Human Gate"
...
# Customer Impact Human Gate

## Purpose
This page gives agents a stable rule pattern for customer impact human gate in `ecommerce-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Customer Impact Human Gate should be handled as rule knowledge that supports repeatable agent behavior.
...
## Examples
- Use customer impact human gate to convert a vague request into explicit fields, checks, and boundaries.
- Use customer impact human gate as a checklist item before the agent produces a final answer.
- Use customer impact human gate during review to separate supported observations from unresolved risks.
- Use customer impact human gate to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating customer impact human gate as permission to invent missing details.
