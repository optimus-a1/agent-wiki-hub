---
title: "Product Recommendation Review Prompt"
...
# Product Recommendation Review Prompt

## Purpose
This page gives agents a stable prompt pattern for product recommendation review prompt in `ecommerce-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Product Recommendation Review Prompt should be handled as prompt knowledge that supports repeatable agent behavior.
...
## Examples
- Use product recommendation review prompt to convert a vague request into explicit fields, checks, and boundaries.
- Use product recommendation review prompt as a checklist item before the agent produces a final answer.
- Use product recommendation review prompt during review to separate supported observations from unresolved risks.
- Use product recommendation review prompt to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating product recommendation review prompt as permission to invent missing details.
