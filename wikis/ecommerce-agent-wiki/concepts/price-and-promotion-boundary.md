---
title: "Price And Promotion Boundary"
...
# Price And Promotion Boundary

## Purpose
This page gives agents a stable concept pattern for price and promotion boundary in `ecommerce-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Price And Promotion Boundary should be handled as concept knowledge that supports repeatable agent behavior.
...
## Examples
- Use price and promotion boundary to convert a vague request into explicit fields, checks, and boundaries.
- Use price and promotion boundary as a checklist item before the agent produces a final answer.
- Use price and promotion boundary during review to separate supported observations from unresolved risks.
- Use price and promotion boundary to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating price and promotion boundary as permission to invent missing details.
