...
# SKU And SPU Distinction

## Purpose
This page gives agents a stable concept pattern for sku and spu distinction in `ecommerce-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- SKU And SPU Distinction should be handled as concept knowledge that supports repeatable agent behavior.
...
## Examples
- Use sku and spu distinction to convert a vague request into explicit fields, checks, and boundaries.
- Use sku and spu distinction as a checklist item before the agent produces a final answer.
- Use sku and spu distinction during review to separate supported observations from unresolved risks.
- Use sku and spu distinction to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating sku and spu distinction as permission to invent missing details.
