---
title: "Return And Refund Concepts"
...
# Return And Refund Concepts

## Purpose
This page gives agents a stable concept pattern for return and refund concepts in `ecommerce-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Return And Refund Concepts should be handled as concept knowledge that supports repeatable agent behavior.
...
## Examples
- Use return and refund concepts to convert a vague request into explicit fields, checks, and boundaries.
- Use return and refund concepts as a checklist item before the agent produces a final answer.
- Use return and refund concepts during review to separate supported observations from unresolved risks.
- Use return and refund concepts to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating return and refund concepts as permission to invent missing details.
