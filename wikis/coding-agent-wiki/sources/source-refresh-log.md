...
- [ ] SRC-029 | wave: wave-3 | priority: 6 | human_confirmation: no | topic: current OpenAI, Codex, GitHub or Vercel product behavior
- [ ] SRC-030 | wave: wave-3 | priority: 6 | human_confirmation: no | topic: current cloud platform build, deploy, runtime and pricing behavior
- [ ] SRC-031 | wave: wave-3 | priority: 6 | human_confirmation: no | topic: current dependency vulnerabilities and security advisories
- [ ] SRC-032 | wave: wave-3 | priority: 6 | human_confirmation: no | topic: current framework, library, CLI and API parameters
