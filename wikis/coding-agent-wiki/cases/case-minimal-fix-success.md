---
title: "Case Minimal Fix Success"
...
# Case Minimal Fix Success

## Purpose
This page gives agents a stable case pattern for case minimal fix success in `coding-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Case Minimal Fix Success should be handled as case knowledge that supports repeatable agent behavior.
...
## Examples
- Use case minimal fix success to convert a vague request into explicit fields, checks, and boundaries.
- Use case minimal fix success as a checklist item before the agent produces a final answer.
- Use case minimal fix success during review to separate supported observations from unresolved risks.
- Use case minimal fix success to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating case minimal fix success as permission to invent missing details.
