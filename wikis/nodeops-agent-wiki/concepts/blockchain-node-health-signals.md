---
title: "Blockchain Node Health Signals"
...
# Blockchain Node Health Signals

## Purpose
This page gives agents a stable concept pattern for blockchain node health signals in `nodeops-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Blockchain Node Health Signals should be handled as concept knowledge that supports repeatable agent behavior.
...
## Examples
- Use blockchain node health signals to convert a vague request into explicit fields, checks, and boundaries.
- Use blockchain node health signals as a checklist item before the agent produces a final answer.
- Use blockchain node health signals during review to separate supported observations from unresolved risks.
- Use blockchain node health signals to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating blockchain node health signals as permission to invent missing details.
