---
title: "Knowledge Pack Review Prompt"
...
# Knowledge Pack Review Prompt

## Purpose
This page gives agents a stable prompt pattern for knowledge pack review prompt in `agent-engineering-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Knowledge Pack Review Prompt should be handled as prompt knowledge that supports repeatable agent behavior.
...
## Examples
- Use knowledge pack review prompt to convert a vague request into explicit fields, checks, and boundaries.
- Use knowledge pack review prompt as a checklist item before the agent produces a final answer.
- Use knowledge pack review prompt during review to separate supported observations from unresolved risks.
- Use knowledge pack review prompt to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating knowledge pack review prompt as permission to invent missing details.
