---
title: "Case Tool Overreach Remediation"
...
# Case Tool Overreach Remediation

## Purpose
This page gives agents a stable case pattern for case tool overreach remediation in `agent-engineering-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Case Tool Overreach Remediation should be handled as case knowledge that supports repeatable agent behavior.
...
## Examples
- Use case tool overreach remediation to convert a vague request into explicit fields, checks, and boundaries.
- Use case tool overreach remediation as a checklist item before the agent produces a final answer.
- Use case tool overreach remediation during review to separate supported observations from unresolved risks.
- Use case tool overreach remediation to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating case tool overreach remediation as permission to invent missing details.
