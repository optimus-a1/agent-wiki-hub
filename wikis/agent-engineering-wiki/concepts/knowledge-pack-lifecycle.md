---
title: "Knowledge Pack Lifecycle"
...
## Purpose
This page gives agents a stable concept pattern for knowledge pack lifecycle in `agent-engineering-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Knowledge Pack Lifecycle should be handled as concept knowledge that supports repeatable agent behavior.
...
## Examples
- Use knowledge pack lifecycle to convert a vague request into explicit fields, checks, and boundaries.
- Use knowledge pack lifecycle as a checklist item before the agent produces a final answer.
- Use knowledge pack lifecycle during review to separate supported observations from unresolved risks.
- Use knowledge pack lifecycle to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating knowledge pack lifecycle as permission to invent missing details.
