---
title: "Commercial Invoice Structure"
...
## Purpose
This page gives agents a stable concept pattern for commercial invoice structure in `customs-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Commercial Invoice Structure should be handled as concept knowledge that supports repeatable agent behavior.
...
## Examples
- Use commercial invoice structure to convert a vague request into explicit fields, checks, and boundaries.
- Use commercial invoice structure as a checklist item before the agent produces a final answer.
- Use commercial invoice structure during review to separate supported observations from unresolved risks.
- Use commercial invoice structure to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating commercial invoice structure as permission to invent missing details.
