---
title: "Certificate Of Conformity Review"
...
## Purpose
This page gives agents a stable concept pattern for certificate of conformity review in `customs-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Certificate Of Conformity Review should be handled as concept knowledge that supports repeatable agent behavior.
...
## Examples
- Use certificate of conformity review to convert a vague request into explicit fields, checks, and boundaries.
- Use certificate of conformity review as a checklist item before the agent produces a final answer.
- Use certificate of conformity review during review to separate supported observations from unresolved risks.
- Use certificate of conformity review to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating certificate of conformity review as permission to invent missing details.
