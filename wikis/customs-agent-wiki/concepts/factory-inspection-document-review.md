---
title: "Factory Inspection Document Review"
...
# Factory Inspection Document Review

## Purpose
This page gives agents a stable concept pattern for factory inspection document review in `customs-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Factory Inspection Document Review should be handled as concept knowledge that supports repeatable agent behavior.
...
## Examples
- Use factory inspection document review to convert a vague request into explicit fields, checks, and boundaries.
- Use factory inspection document review as a checklist item before the agent produces a final answer.
- Use factory inspection document review during review to separate supported observations from unresolved risks.
- Use factory inspection document review to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating factory inspection document review as permission to invent missing details.
