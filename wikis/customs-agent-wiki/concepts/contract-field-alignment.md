---
title: "Contract Field Alignment"
...
## Purpose
This page gives agents a stable concept pattern for contract field alignment in `customs-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Contract Field Alignment should be handled as concept knowledge that supports repeatable agent behavior.
...
## Examples
- Use contract field alignment to convert a vague request into explicit fields, checks, and boundaries.
- Use contract field alignment as a checklist item before the agent produces a final answer.
- Use contract field alignment during review to separate supported observations from unresolved risks.
- Use contract field alignment to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating contract field alignment as permission to invent missing details.
