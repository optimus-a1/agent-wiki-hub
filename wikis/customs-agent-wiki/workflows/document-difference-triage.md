---
title: "Document Difference Triage"
...
# Document Difference Triage

## Purpose
This page gives agents a stable workflow pattern for document difference triage in `customs-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Document Difference Triage should be handled as workflow knowledge that supports repeatable agent behavior.
...
## Examples
- Use document difference triage to convert a vague request into explicit fields, checks, and boundaries.
- Use document difference triage as a checklist item before the agent produces a final answer.
- Use document difference triage during review to separate supported observations from unresolved risks.
- Use document difference triage to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating document difference triage as permission to invent missing details.
