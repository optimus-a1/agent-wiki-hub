---
title: "Factory Document Review Workflow"
...
# Factory Document Review Workflow

## Purpose
This page gives agents a stable workflow pattern for factory document review workflow in `customs-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Factory Document Review Workflow should be handled as workflow knowledge that supports repeatable agent behavior.
...
## Examples
- Use factory document review workflow to convert a vague request into explicit fields, checks, and boundaries.
- Use factory document review workflow as a checklist item before the agent produces a final answer.
- Use factory document review workflow during review to separate supported observations from unresolved risks.
- Use factory document review workflow to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating factory document review workflow as permission to invent missing details.
