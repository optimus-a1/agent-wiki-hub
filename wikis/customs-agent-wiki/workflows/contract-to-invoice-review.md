---
title: "Contract To Invoice Review"
...
# Contract To Invoice Review

## Purpose
This page gives agents a stable workflow pattern for contract to invoice review in `customs-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Contract To Invoice Review should be handled as workflow knowledge that supports repeatable agent behavior.
...
## Examples
- Use contract to invoice review to convert a vague request into explicit fields, checks, and boundaries.
- Use contract to invoice review as a checklist item before the agent produces a final answer.
- Use contract to invoice review during review to separate supported observations from unresolved risks.
- Use contract to invoice review to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating contract to invoice review as permission to invent missing details.
