---
title: "Case Manual Review Escalation"
...
# Case Manual Review Escalation

## Purpose
This page gives agents a stable case pattern for case manual review escalation in `customs-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Case Manual Review Escalation should be handled as case knowledge that supports repeatable agent behavior.
...
## Examples
- Use case manual review escalation to convert a vague request into explicit fields, checks, and boundaries.
- Use case manual review escalation as a checklist item before the agent produces a final answer.
- Use case manual review escalation during review to separate supported observations from unresolved risks.
- Use case manual review escalation to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating case manual review escalation as permission to invent missing details.
