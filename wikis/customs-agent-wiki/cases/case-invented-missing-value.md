---
title: "Case Invented Missing Value"
...
# Case Invented Missing Value

## Purpose
This page gives agents a stable case pattern for case invented missing value in `customs-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Case Invented Missing Value should be handled as case knowledge that supports repeatable agent behavior.
...
## Examples
- Use case invented missing value to convert a vague request into explicit fields, checks, and boundaries.
- Use case invented missing value as a checklist item before the agent produces a final answer.
- Use case invented missing value during review to separate supported observations from unresolved risks.
- Use case invented missing value to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating case invented missing value as permission to invent missing details.
