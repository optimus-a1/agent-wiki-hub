---
title: "Customs Policy Source Gate"
...
# Customs Policy Source Gate

## Purpose
This page gives agents a stable rule pattern for customs policy source gate in `customs-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Customs Policy Source Gate should be handled as rule knowledge that supports repeatable agent behavior.
...
## Examples
- Use customs policy source gate to convert a vague request into explicit fields, checks, and boundaries.
- Use customs policy source gate as a checklist item before the agent produces a final answer.
- Use customs policy source gate during review to separate supported observations from unresolved risks.
- Use customs policy source gate to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating customs policy source gate as permission to invent missing details.
