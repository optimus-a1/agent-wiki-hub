---
title: "Currency And Amount Gate"
...
# Currency And Amount Gate

## Purpose
This page gives agents a stable rule pattern for currency and amount gate in `customs-agent-wiki`. It is model-synthesized stable knowledge, not an authoritative source and not a current-fact record.

## Stable Knowledge
- Currency And Amount Gate should be handled as rule knowledge that supports repeatable agent behavior.
...
## Examples
- Use currency and amount gate to convert a vague request into explicit fields, checks, and boundaries.
- Use currency and amount gate as a checklist item before the agent produces a final answer.
- Use currency and amount gate during review to separate supported observations from unresolved risks.
- Use currency and amount gate to decide whether a human gate or source gate is required.

## Anti-Patterns
- Treating currency and amount gate as permission to invent missing details.
