# Wave 3 Source Review Work Order: TICKET-SRC-026

Generated: 2026-05-31

## Scope

- Work order: `WAVE3-WORKORDER-TICKET-SRC-026`
- Ticket: `TICKET-SRC-026`
- Task: `SRC-026`
...
```bash
python3 scripts/record_source_evidence.py --ticket-id TICKET-SRC-026 --status pending --dry-run
```
