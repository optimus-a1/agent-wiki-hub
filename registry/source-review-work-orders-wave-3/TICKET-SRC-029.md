# Wave 3 Source Review Work Order: TICKET-SRC-029

Generated: 2026-05-31

## Scope

- Work order: `WAVE3-WORKORDER-TICKET-SRC-029`
- Ticket: `TICKET-SRC-029`
- Task: `SRC-029`
...
```bash
python3 scripts/record_source_evidence.py --ticket-id TICKET-SRC-029 --status pending --dry-run
```
