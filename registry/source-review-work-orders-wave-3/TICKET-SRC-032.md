# Wave 3 Source Review Work Order: TICKET-SRC-032

Generated: 2026-05-31

## Scope

- Work order: `WAVE3-WORKORDER-TICKET-SRC-032`
- Ticket: `TICKET-SRC-032`
- Task: `SRC-032`
...
```bash
python3 scripts/record_source_evidence.py --ticket-id TICKET-SRC-032 --status pending --dry-run
```
