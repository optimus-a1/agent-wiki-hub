# Wave 3 Source Review Work Order: TICKET-SRC-027

Generated: 2026-05-31

## Scope

- Work order: `WAVE3-WORKORDER-TICKET-SRC-027`
- Ticket: `TICKET-SRC-027`
- Task: `SRC-027`
...
- wikis/agent-engineering-wiki/AGENTS.md
- wikis/agent-engineering-wiki/manifest.yaml
- wikis/agent-engineering-wiki/README.md
- wikis/agent-engineering-wiki/rules/
...
- release notes
- benchmark report with date

## Local Artifacts

- Source notes: `wikis/agent-engineering-wiki/sources/source-notes.md`
- Evidence log: `wikis/agent-engineering-wiki/sources/source-refresh-log.md`
...
```bash
python3 scripts/record_source_evidence.py --ticket-id TICKET-SRC-027 --status pending --dry-run
```
