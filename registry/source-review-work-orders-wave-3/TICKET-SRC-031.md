# Wave 3 Source Review Work Order: TICKET-SRC-031

Generated: 2026-05-31

## Scope

- Work order: `WAVE3-WORKORDER-TICKET-SRC-031`
- Ticket: `TICKET-SRC-031`
- Task: `SRC-031`
...
- wikis/coding-agent-wiki/AGENTS.md
- wikis/coding-agent-wiki/manifest.yaml
- wikis/coding-agent-wiki/README.md
- wikis/coding-agent-wiki/rules/
- wikis/coding-agent-wiki/sources/source-notes.md

## Suggested Source Types

- official security advisory
- package registry advisory
- vendor bulletin

## Local Artifacts

- Source notes: `wikis/coding-agent-wiki/sources/source-notes.md`
- Evidence log: `wikis/coding-agent-wiki/sources/source-refresh-log.md`
...
```bash
python3 scripts/record_source_evidence.py --ticket-id TICKET-SRC-031 --status pending --dry-run
```
