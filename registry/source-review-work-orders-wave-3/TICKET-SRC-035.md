# Wave 3 Source Review Work Order: TICKET-SRC-035

Generated: 2026-05-31

## Scope

- Work order: `WAVE3-WORKORDER-TICKET-SRC-035`
- Ticket: `TICKET-SRC-035`
- Task: `SRC-035`
...
```bash
python3 scripts/record_source_evidence.py --ticket-id TICKET-SRC-035 --status pending --dry-run
```
