# Wave 3 Source Review Work Order: TICKET-SRC-033

Generated: 2026-05-31

## Scope

- Work order: `WAVE3-WORKORDER-TICKET-SRC-033`
- Ticket: `TICKET-SRC-033`
- Task: `SRC-033`
...
```bash
python3 scripts/record_source_evidence.py --ticket-id TICKET-SRC-033 --status pending --dry-run
```
