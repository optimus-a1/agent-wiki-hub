# Wave 3 Source Review Work Order: TICKET-SRC-028

Generated: 2026-05-31

## Scope

- Work order: `WAVE3-WORKORDER-TICKET-SRC-028`
- Ticket: `TICKET-SRC-028`
- Task: `SRC-028`
...
```bash
python3 scripts/record_source_evidence.py --ticket-id TICKET-SRC-028 --status pending --dry-run
```
