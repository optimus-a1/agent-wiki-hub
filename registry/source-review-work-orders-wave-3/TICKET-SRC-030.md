# Wave 3 Source Review Work Order: TICKET-SRC-030

Generated: 2026-05-31

## Scope

- Work order: `WAVE3-WORKORDER-TICKET-SRC-030`
- Ticket: `TICKET-SRC-030`
- Task: `SRC-030`
...
```bash
python3 scripts/record_source_evidence.py --ticket-id TICKET-SRC-030 --status pending --dry-run
```
